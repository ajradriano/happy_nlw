...
export default function OrphanageDetails() {
  ...
  function openInGoogleMaps() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanage?.lat},${orphanage?.lng}`);
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          <MapView 
            initialRegion={{
              latitude: orphanage.lat,
              longitude: orphanage.lng,
              latitudeDelta: 0.008,
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={openInGoogleMaps} >
